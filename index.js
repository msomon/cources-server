...
async function run() {
    ...
    const foodsCollection = client.db('cources').collection('cource')
    const cartsCollection = client.db('cources').collection('carts')
    const reviewsCollection = client.db('cources').collection('reviews')
    const usersCollection = client.db('cources').collection('users')
    const myprofileCollection = client.db('cources').collection('myprofiles')
    const paymentCollection = client.db('cources').collection('payments')
